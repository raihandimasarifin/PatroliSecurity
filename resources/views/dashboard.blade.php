...
--ring: 240 4.9% 83.9%;
  ...
  <div class="mt-8 space-y-4">
    ...
    <a href="users" class="flex items-center justify-center w-full bg-secondary text-secondary-foreground p-4 rounded-lg shadow-lg hover:bg-secondary/80">
      <img aria-hidden="true" alt="management icon" src="https://openui.fly.dev/openui/24x24.svg?text=👤" class="mr-2" />
      MANAJEMEN USER
    </a>
    <a href="room" class="flex items-center justify-center w-full bg-secondary text-secondary-foreground p-4 rounded-lg shadow-lg hover:bg-secondary/80">
      <img aria-hidden="true" alt="ruangan icon" src="https://openui.fly.dev/openui/24x24.svg?text=🏢" class="mr-2" />
      RUANGAN
    </a>
